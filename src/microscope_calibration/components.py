...
class Descanner:
    ...
    def step(self, ray: Ray):
        ...
        (
            ...
            descan_error_dyx,
            descan_error_dyy,
            descan_error_scan_pos_x,
            descan_error_scan_pos_y,
        ...
        new_x = x + (sp_x * descan_error_xx + sp_y * descan_error_xy + descan_error_scan_pos_x - sp_x) * _one
        new_y = y + (sp_y * descan_error_yy + sp_y * descan_error_yx + descan_error_scan_pos_y - sp_y) * _one
